...
} from "@contracts/stability-pool/strategy-steps/BalancerV3StablePoolMathSwapStep.sol";
import {
    ERC4626WithdrawalStep
} from "@contracts/stability-pool/strategy-steps/ERC4626WithdrawalStep.sol";
import {
    CurveSwapStep
} from "@contracts/stability-pool/strategy-steps/CurveSwapStep.sol";
import {
    VeloSwapStep
} from "@contracts/stability-pool/strategy-steps/VeloSwapStep.sol";
import {
    VeloCLSwapStepViewQuoter
} from "@contracts/stability-pool/strategy-steps/VeloCLSwapStepViewQuoter.sol";
import {
    VeloLPRemovalStep
} from "@contracts/stability-pool/strategy-steps/VeloLPRemovalStep.sol";
import {
    VeloLPRemoveAndSwapStep
} from "@contracts/stability-pool/strategy-steps/VeloLPRemoveAndSwapStep.sol";
import {
    BeefyVaultWithdrawalStep
} from "@contracts/stability-pool/strategy-steps/BeefyVaultWithdrawalStep.sol";
import {
    YearnVaultWithdrawalStep
} from "@contracts/stability-pool/strategy-steps/YearnVaultWithdrawalStep.sol";
...
contract StepsScript is MainnetDeployment, Common, Script {
    ...
    address internal constant BALANCER_V3_STEP =
        0x0000000000000000000000000000000000000000;
    address internal constant ERC4626_STEP =
        0x0000000000000000000000000000000000000000;
    address internal constant CURVE_STEP =
        0x0000000000000000000000000000000000000000;
    address internal constant VELO_SWAP_STEP =
        0x0000000000000000000000000000000000000000;
    address internal constant VELO_CL_SWAP_STEP =
        0x0000000000000000000000000000000000000000;
    address internal constant VELO_LP_REMOVAL_STEP =
        0x0000000000000000000000000000000000000000;
    address internal constant VELO_LP_REMOVE_AND_SWAP_STEP =
        0x0000000000000000000000000000000000000000;
    address internal constant BEEFY_STEP =
        0x0000000000000000000000000000000000000000;
    address internal constant YEARN_STEP =
        0x0000000000000000000000000000000000000000;

    // --- CONTRACT ADDRESSES ---
    address internal constant VELO_CL_FACTORY =
        0xCc0bDDB707055e04e497aB22a59c2aF4391cd12F;
    address internal constant VELO_CL_ROUTER =
    ...
    address internal constant VELO_FACTORY =
        0xF1046053aa5682b4F9a81b5481394DA16BE5FF5a;

    address internal constant BALANCER_V3_ROUTER =
    ...
    address internal constant BOLD_ADDR =
        0x03569CC076654F82679C4BA2124D64774781B01D;
    address internal constant HAI_ADDR =
        0x10398AbC267496E49106B07dd6BE13364D10dC71;
    address internal constant ALETH_ADDR =
        0x3E29D3A9316dAB217754d13b28646B76607c5f04;
    address internal constant RETH_ADDR =
        0x9Bcef72be871e61ED4fBbc7630889beE758eb81D;
    address internal constant WA_OPT_WETH_ADDR =
        0x464b808c2C7E04b07e860fDF7a91870620246148;
    address internal constant HAIVELO_ADDR =
        0x20A7EaF4a922DF50b312ef61AeA8B6E1deb5DdD6;
    address internal constant VELO_ADDR =
        0x9560e827aF36c94D2Ac33a39bCE1Fe78631088Db;
    address internal constant TBTC_ADDR =
        0x6c84a8f1c29108F47a79964b5Fe888D4f4D0dE40;
    address internal constant WBTC_ADDR =
        0x68f180fcCe6836688e9084f035309E29Bf0A2095;
    address internal constant MSETH_ADDR =
        0x1610e3c85dd44Af31eD7f33a63642012Dca0C5A5;
    address internal constant OP_ADDR =
        0x4200000000000000000000000000000000000042;
    address internal constant LUSD_ADDR =
        0xc40F949F8a4e094D1b49a23ea9241D289B7b2819;

    // --- POOL ADDRESSES ---
    address internal constant CURVE_BOLD_HAI_POOL =
        0xC4ea2ED83bC9207398fa5dB31Ee4E7477dC34fd5;
    address internal constant BALANCER_V3_RETH_WA_OPT_WETH_POOL =
        0x870c0Af8A1af0B58b4b0bD31CE4fe72864ae45BE;
    address internal constant VELO_HAIVELO_VELO_POOL =
        0x5535Cdc333FC8f08f6183e7064202C3917E9346C;
    address internal constant VELO_USDC_VELO_POOL =
        0xa0A215dE234276CAc1b844fD58901351a50fec8A;
    address internal constant WETH_USDC_VELO_CL_POOL =
        0x478946BcD4a5a22b316470F5486fAfb928C0bA25;
    address internal constant WSTETH_WETH_VELO_CL_POOL =
        0xbF30Ff33CF9C6b0c48702Ff17891293b002DfeA4;
    address internal constant TBTC_WBTC_VELO_POOL =
        0x8949A8E02998d76D7a703cAC9eE7e0f529828011;
    address internal constant WBTC_USDC_VELO_POOL =
        0xCF50DEA65EE80eBDDAA61005a960ef5A5c995A99;
    address internal constant MSETH_WETH_VELO_POOL =
        0x917AA69D539D6518440dd0BEA2eaAc142a8d5610;
    address internal constant OP_WETH_VELO_POOL =
        0x4DC22588Ade05C40338a9D95A6da9dCeE68Bcd60;
    address internal constant BOLD_LUSD_VELO_POOL =
        0xf2034BF7922620b721183a894a3449bad7Ee97b3;
    address internal constant ALETH_WETH_VELO_POOL =
        0xa1055762336F92b4B8d2eDC032A0Ce45ead6280a;

    // --- BEEFY VAULT ADDRESSES ---
    address internal constant BOLD_LUSD_VELO_BEEFY_VAULT =
        0xC06C0A19d0A3eD7B3BA9D7c3101B6BC9634b84a9;

    // --- YEARN VAULT ADDRESSES ---
    address internal constant ALETH_WETH_YEARN_VAULT =
        0xf7D66b41Cd4241eae450fd9D2d6995754634D9f3;

    address internal constant MSETH_WETH_YEARN_VAULT =
        0xd0d2Ac44Cc842079e978bB11b094764f7D0dec6A;

    // ============================================================
    //                      VELO CL SWAP STEPS
    // ============================================================

    IStabilityPool.StepConfig internal WETH_USDC_VELO_CL_STEP_CONFIG =
        IStabilityPool.StepConfig({
    ...
    IStabilityPool.StepConfig internal WSTETH_WETH_VELO_CL_STEP_CONFIG =
        IStabilityPool.StepConfig({
            step: VELO_CL_SWAP_STEP,
            data: abi.encode(
                VeloCLSwapStepViewQuoter.Data({
    ...
    IStabilityPool.StepConfig internal TBTC_WBTC_VELO_CL_STEP_CONFIG =
        IStabilityPool.StepConfig({
            step: VELO_CL_SWAP_STEP,
            data: abi.encode(
                VeloCLSwapStepViewQuoter.Data({
    ...
    IStabilityPool.StepConfig internal WBTC_USDC_VELO_CL_STEP_CONFIG =
        IStabilityPool.StepConfig({
            step: VELO_CL_SWAP_STEP,
            data: abi.encode(
                VeloCLSwapStepViewQuoter.Data({
    ...
    IStabilityPool.StepConfig internal OP_WETH_VELO_CL_STEP_CONFIG =
        IStabilityPool.StepConfig({
            step: VELO_CL_SWAP_STEP,
            data: abi.encode(
                VeloCLSwapStepViewQuoter.Data({
    ...
    IStabilityPool.StepConfig internal USDC_BOLD_VELO_STEP_CONFIG =
        IStabilityPool.StepConfig({
            step: VELO_SWAP_STEP,
            data: abi.encode(
                VeloSwapStep.Data({
    ...
    IStabilityPool.StepConfig internal ALETH_WETH_VELO_STEP_CONFIG =
        IStabilityPool.StepConfig({
            step: VELO_SWAP_STEP,
            data: abi.encode(
                VeloSwapStep.Data({
    ...
    IStabilityPool.StepConfig internal HAIVELO_VELO_VELO_STEP_CONFIG =
        IStabilityPool.StepConfig({
            step: VELO_SWAP_STEP,
            data: abi.encode(
                VeloSwapStep.Data({
    ...
    IStabilityPool.StepConfig internal VELO_USDC_VELO_STEP_CONFIG =
        IStabilityPool.StepConfig({
            step: VELO_SWAP_STEP,
            data: abi.encode(
                VeloSwapStep.Data({
    ...
    IStabilityPool.StepConfig internal MSETH_WETH_VELO_STEP_CONFIG =
        IStabilityPool.StepConfig({
            step: VELO_SWAP_STEP,
            data: abi.encode(
                VeloSwapStep.Data({
    ...
    IStabilityPool.StepConfig internal BOLD_HAI_CURVE_STEP_CONFIG =
        IStabilityPool.StepConfig({
            step: CURVE_STEP,
            data: abi.encode(
                CurveSwapStep.Data({
    ...
    IStabilityPool.StepConfig
        internal RETH_WA_OPT_WETH_BALANCER_V3_STEP_CONFIG =
            IStabilityPool.StepConfig({
    ...
    IStabilityPool.StepConfig
        internal WA_OPT_WETH_ERC4626_WITHDRAWAL_STEP_CONFIG =
            IStabilityPool.StepConfig({
                step: ERC4626_STEP,
                data: abi.encode(
                    ERC4626WithdrawalStep.Data({
                        vault: WA_OPT_WETH_ADDR,
                        vaultToken: WA_OPT_WETH_ADDR,
                        assetToken: WETH_ADDR
                    })
                ),
                slippageBps: 0
            });
    ...
    IStabilityPool.StepConfig
        internal BOLD_LUSD_VELO_BEEFY_VAULT_WITHDRAWAL_STEP_CONFIG =
            IStabilityPool.StepConfig({
                step: BEEFY_STEP,
                data: abi.encode(
    ...
    IStabilityPool.StepConfig
        internal ALETH_WETH_YEARN_VAULT_WITHDRAWAL_STEP_CONFIG =
            IStabilityPool.StepConfig({
                step: YEARN_STEP,
                data: abi.encode(
    ...
    IStabilityPool.StepConfig
        internal MSETH_WETH_YEARN_VAULT_WITHDRAWAL_STEP_CONFIG =
            IStabilityPool.StepConfig({
                step: YEARN_STEP,
                data: abi.encode(
                    YearnVaultWithdrawalStep.Data({
    ...
    IStabilityPool.StepConfig
        internal BOLD_LUSD_VELO_LP_REMOVAL_AND_SWAP_STEP_CONFIG =
            IStabilityPool.StepConfig({
    ...
    IStabilityPool.StepConfig
        internal ALETH_WETH_VELO_LP_REMOVAL_AND_SWAP_STEP_CONFIG =
            IStabilityPool.StepConfig({
                step: VELO_LP_REMOVE_AND_SWAP_STEP,
                data: abi.encode(
                    VeloLPRemoveAndSwapStep.Data({
    ...
    IStabilityPool.StepConfig
        internal MSETH_WETH_VELO_LP_REMOVAL_AND_SWAP_STEP_CONFIG =
            IStabilityPool.StepConfig({
                step: VELO_LP_REMOVE_AND_SWAP_STEP,
                data: abi.encode(
                    VeloLPRemoveAndSwapStep.Data({
    ...
    function _configureWETH() internal {
        IStabilityPool.StepConfig[]
            memory _steps = new IStabilityPool.StepConfig[](3);
    ...
    function _configureWSTETH() internal {
        IStabilityPool.StepConfig[]
            memory _steps = new IStabilityPool.StepConfig[](4);
    ...
    function _configureRETH() internal {
        IStabilityPool.StepConfig[]
            memory _steps = new IStabilityPool.StepConfig[](5);
