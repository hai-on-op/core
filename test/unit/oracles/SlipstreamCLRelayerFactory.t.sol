...
abstract contract Base is HaiTest {
  ...
  ISlipstreamCLFactory mockUniV3Factory =
    ISlipstreamCLFactory(mockContract(0xCc0bDDB707055e04e497aB22a59c2aF4391cd12F, 'UniswapV3Factory'));
  ...
  SlipstreamCLRelayerFactory uniV3RelayerFactory;
  SlipstreamCLRelayerChild uniV3RelayerChild = SlipstreamCLRelayerChild(
    label(address(0x0000000000000000000000007f85e9e000597158aed9320b5a5e11ab8cc7329a), 'SlipstreamCLRelayerChild')
  );

  function setUp() public virtual {
    vm.startPrank(deployer);

    uniV3RelayerFactory = new SlipstreamCLRelayerFactory(address(mockUniV3Factory));
    label(address(uniV3RelayerFactory), 'SlipstreamCLRelayerFactory');
  ...
  function _mockGetPool(address _baseToken, address _quoteToken, uint24 _feeTier, address _uniV3Pool) internal {
    vm.mockCall(
      ...
      abi.encodeCall(mockUniV3Factory.getPool, (_baseToken, _quoteToken, int24(_feeTier))),
...
contract Unit_SlipstreamCLRelayerFactory_Constructor is Base {
  ...
  function test_Emit_AddAuthorization() public happyPath {
    ...
    new SlipstreamCLRelayerFactory(address(mockUniV3Factory));
  }
}

contract Unit_SlipstreamCLRelayerFactory_DeploySlipstreamCLRelayer is Base {
  ...
  function test_Deploy_SlipstreamCLRelayerChild(
    uint24 _feeTier,
    uint32 _quotePeriod,
    ...
    // bytecode
    assertEq(address(uniV3RelayerChild).code, type(SlipstreamCLRelayerChild).runtimeCode);
    // params
  ...
  function test_Set_SlipstreamCLRelayers(
    uint24 _feeTier,
    uint32 _quotePeriod,
    string memory _symbol,
    uint8 _decimals
  ...
  function test_Emit_NewSlipstreamCLRelayer(
    uint24 _feeTier,
    uint32 _quotePeriod,
    string memory _symbol,
    uint8 _decimals
  ...
  function test_Return_SlipstreamCLRelayer(
    uint24 _feeTier,
    uint32 _quotePeriod,
    string memory _symbol,
    uint8 _decimals
