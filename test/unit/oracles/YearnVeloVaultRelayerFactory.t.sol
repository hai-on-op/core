...
contract Unit_YearnVeloVaultRelayerFactory_DeployYearnVeloVaultRelayer is Base {
  event NewYearnVeloVaultRelayer(
    address indexed _yearnVeloVaultRelayer,
    address _yearnVault,
    address _veloPool,
  ...
  function test_Revert_Unauthorized() public {
    ...
    yearnVeloVaultRelayerFactory.deployYearnVeloVaultRelayer(
      mockYearnVault, mockVeloPool, mockVeloLpOracle
    );
  }
