...
interface IVeNFTManager is IAuthorizable, IModifiable {
    ...
    event VeNFTManagerTokenWithdrawn(
    ...
    event VeNFTManagerSuperchainRecipientSet(
        uint256 _chainId,
        address _recipient
    );
    ...
    function secondaryManager()
        external
        view
        returns (address _secondaryManager);
