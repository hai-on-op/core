 ...
 */
contract BeefyVeloVaultRelayer is
  AbstractVeloVaultRelayer,
  IBeefyVeloVaultRelayer
{
  ...
  constructor(
    ...
    AbstractVeloVaultRelayer(
      _veloPool,
      _veloLpOracle,
      string(abi.encodePacked(_beefyVault.symbol(), " / USD"))
    )
  {
