...
} from "@interfaces/oracles/ICurveStableSwapNGRelayer.sol";
...
contract CurveStableSwapNGRelayer is IBaseOracle, ICurveStableSwapNGRelayer {
    ...
    {
        uint256 _priceBase = baseIndex == 0
            ? WAD
            : pool.price_oracle(baseIndex - 1);
        uint256 _priceQuote = quoteIndex == 0
            ? WAD
            : pool.price_oracle(quoteIndex - 1);
